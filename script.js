(() => {
  const translations = {
    en: {
      ...
      'title.itemdropper': '8bits Game Editor — Item Dropper',
      ...
      'nav.worldConception': 'World Conception',
      ...
      'hero.subtitle': 'A NON-professional digital workshop for pixel makers and indie developers.',
      'section.toolchain.title': 'Toolchain',
      'section.toolchain.subtitle': 'A playful toolchain for testing ideas, building tiny worlds, and experimenting without pressure.',
      'module.pixel.title': 'Pixel Editor',
      'module.pixel.body': 'Sketch sprites and tiles fast on a true 16x16 grid, try weird ideas, and see what sticks.',
      'module.pixel.tag': 'Core Editor',
      'module.palette.title': 'Palette Engine',
      'module.palette.body': 'Keep palettes simple, swap colors quickly, and explore moods without overthinking the setup.',
      'module.palette.tag': 'Color Lab',
      'module.tile.title': 'Tile Intelligence',
      'module.tile.body': 'Test repeats in real time and block out floors, walls, and map layers for fun prototypes.',
      'module.tile.tag': 'Preview Grid',
      'module.future.title': 'Future Labs',
      'module.future.body': 'More toy-box tools can plug in later: animation tests, extra layers, strange brushes, whatever the project needs.',
      'module.future.tag': 'In Progress',
      'section.philosophy.title': 'Workshop Philosophy',
      'section.philosophy.subtitle': 'Built for fun, iteration, and low-pressure experimentation rather than polished production pipelines.',
      'philosophy.experimental.title': 'Experimental, Not Chaotic',
      'philosophy.experimental.body': 'The goal is to try things quickly, break ideas safely, and keep enough structure to stay usable.',
      'philosophy.studio.title': 'A Playground With Tools',
      ...
      'map.toolSeqPaint': 'Seq Paint',
      'map.toolStampPaint': 'Stamp Paint',
      ...
      'items.addAsset': 'Add Item',
      'items.assetGrid': 'Item Grid',
      'items.assetGridHint': 'Select an item sheet to preview its sprites.',
      'items.builder': 'Item Builder',
      'items.builderHint': 'Overlay props and gameplay items directly onto a base map.',
      ...
      'items.undo': 'Undo',
      'items.redo': 'Redo',
      'items.exportJson': 'Export JSON',
      'items.importJson': 'Import JSON',
      'items.baseMap': 'Base map',
      'items.baseMapEmpty': 'No base map loaded.',
      'items.refreshBaseMap': 'Refresh Base Map',
      ...
      'items.viewCollision': 'Collision',
      'items.viewDepth': 'Player Depth',
      'items.cacheTitle': 'Cache',
      'items.cacheClose': 'Close',
      'items.cacheCount': 'Items',
      'items.cacheSize': 'Estimated size',
      'items.cacheEmpty': 'Cache is empty.',
      ...
      'itemdropper.title': 'Item Dropper',
      'itemdropper.subtitle': 'Import a base map, place interactive items, and export the gameplay layer.',
      'itemdropper.assets': 'Item Sheets',
      'itemdropper.assetsSubtitle': 'Configure interactive item sheets and mask collision if needed.',
      'itemdropper.addAsset': 'Add Item',
      'itemdropper.assetGrid': 'Item Grid',
      'itemdropper.assetGridHint': 'Select an item sheet to preview its sprites.',
      'itemdropper.builder': 'Item Builder',
      'itemdropper.builderHint': 'Place interactive items directly on top of the base map.',
      ...
      'itemdropper.exportJson': 'Export JSON',
      'itemdropper.importJson': 'Import JSON',
      'itemdropper.baseMap': 'Base map',
      'itemdropper.baseMapEmpty': 'No base map loaded.',
      'itemdropper.refreshBaseMap': 'Refresh Base Map',
      'itemdropper.cellSize': 'Cell Size',
      'itemdropper.tool': 'Tool',
      'itemdropper.view': 'View',
      'itemdropper.viewNormal': 'Normal',
      'itemdropper.viewItems': 'Items',
      'itemdropper.viewCollision': 'Collision',
      'itemdropper.viewDepth': 'Player Depth',
      'itemdropper.cacheTitle': 'Cache',
      'itemdropper.cacheClose': 'Close',
      'itemdropper.cacheCount': 'Items',
      'itemdropper.cacheSize': 'Estimated size',
      'itemdropper.cacheEmpty': 'Cache is empty.',
      'itemdropper.cachePurge': 'Purge cache',
      'itemdropper.maskTitle': 'Edit Mask',
      'itemdropper.maskSubtitle': 'Paint passable and blocking zones on each sprite.',
      'itemdropper.maskBlocking': 'Blocking',
      'itemdropper.maskPassable': 'Passable',
      'itemdropper.animationTitle': 'Interaction Animation',
      'itemdropper.animationSubtitle': 'Configure start, animation, end, and loop sprites for the selected item sheet.',
      'itemdropper.animationStart': 'Start image',
      'itemdropper.animationFrames': 'Animation images',
      'itemdropper.animationFramesHint': 'Use commas or ranges, for example 2,3,4-6.',
      'itemdropper.animationEnd': 'End image',
      'itemdropper.animationLoop': 'Loop',
      'itemdropper.animationLoopOn': 'Yes',
      'itemdropper.animationLoopOff': 'No',
      'itemdropper.animationLoopFrom': 'Loop from',
      'itemdropper.animationLoopTo': 'Loop to',
      'itemdropper.animationPreview': 'Preview',
      'itemdropper.animationTarget': 'Sprite picker target',
      'npcdropper.title': 'NPC Dropper',
      'npcdropper.subtitle': 'Import a base map, place NPCs, and export the character layer.',
      'npcdropper.assets': 'NPC Sheets',
      'npcdropper.assetsSubtitle': 'Configure NPC sheets, facing, behavior, and collision.',
      'npcdropper.addAsset': 'Add NPC',
      'npcdropper.assetGrid': 'NPC Grid',
      'npcdropper.assetGridHint': 'Select an NPC sheet to preview its sprites.',
      'npcdropper.builder': 'NPC Builder',
      'npcdropper.builderHint': 'Place NPCs directly on top of the base map.',
      ...
      'npcdropper.exportJson': 'Export JSON',
      'npcdropper.importJson': 'Import JSON',
      'npcdropper.baseMap': 'Base map',
      'npcdropper.baseMapEmpty': 'No base map loaded.',
      'npcdropper.refreshBaseMap': 'Refresh Base Map',
      'npcdropper.cellSize': 'Cell Size',
      'npcdropper.tool': 'Tool',
      'npcdropper.view': 'View',
      'npcdropper.viewNormal': 'Normal',
      'npcdropper.viewItems': 'NPCs',
      'npcdropper.viewCollision': 'Collision',
      'npcdropper.viewDepth': 'Player Depth',
      'npcdropper.cacheTitle': 'Cache',
      'npcdropper.cacheClose': 'Close',
      'npcdropper.cacheCount': 'Items',
      'npcdropper.cacheSize': 'Estimated size',
      'npcdropper.cacheEmpty': 'Cache is empty.',
      'npcdropper.cachePurge': 'Purge cache',
      'npcdropper.maskTitle': 'Edit Mask',
      'npcdropper.maskSubtitle': 'Paint passable and blocking zones on each sprite.',
      'npcdropper.maskBlocking': 'Blocking',
      'npcdropper.maskPassable': 'Passable'
    },
    fr: {
      ...
      'nav.worldConception': 'Conception de monde',
      ...
      'section.toolchain.subtitle': "Une chaîne d'outils ludique pour tester des idées, construire de petits mondes et expérimenter sans pression.",
      'module.pixel.title': 'Éditeur pixel',
      'module.pixel.body': 'Esquisse vite des sprites et des tiles sur une vraie grille 16x16, teste des idées bizarres et garde ce qui marche.',
      'module.pixel.tag': 'Éditeur central',
      'module.palette.title': 'Moteur de palette',
      'module.palette.body': 'Garde des palettes simples, change les couleurs rapidement et explore des ambiances sans alourdir le process.',
      'module.palette.tag': 'Laboratoire couleur',
      'module.tile.title': 'Intelligence de tiling',
      'module.tile.body': 'Visualise les répétitions en direct et bloque sols, murs et couches de map pour des prototypes fun.',
      'module.tile.tag': 'Grille de prévisualisation',
      'module.future.title': 'Futurs laboratoires',
      'module.future.body': "D'autres outils pourront s'ajouter ensuite : tests d'animation, couches en plus, brosses étranges, selon les besoins.",
      'module.future.tag': 'En cours',
      'section.philosophy.title': "Philosophie de l'atelier",
      'section.philosophy.subtitle': "Pensé pour le fun, l'itération et l'expérimentation tranquille, pas pour une pipeline de production lourde.",
      'philosophy.experimental.title': 'Expérimental, pas chaotique',
      'philosophy.experimental.body': "Le but est d'essayer vite, de casser des idées sans risque, et de garder juste assez de structure pour rester efficace.",
      'philosophy.studio.title': "Un terrain de jeu avec des outils",
      ...
      'items.addAsset': 'Ajouter item',
      'items.assetGrid': 'Grille items',
      'items.assetGridHint': "Selectionner une sheet d'items pour voir ses sprites.",
      'items.builder': 'Construction items',
      'items.builderHint': 'Superposer decors et objets de gameplay directement sur une map de base.',
      'items.options': 'Options',
      ...
      'items.undo': 'Undo',
      'items.redo': 'Redo',
      'items.exportJson': 'Exporter JSON',
      'items.importJson': 'Importer JSON',
      'items.baseMap': 'Map de base',
      'items.baseMapEmpty': 'Aucune map de base chargee.',
      'items.refreshBaseMap': 'Rafraichir map de base',
      ...
      'items.viewItems': 'Items',
      'items.viewCollision': 'Collision',
      'items.viewDepth': 'Profondeur joueur',
      'items.cacheTitle': 'Cache',
      'items.cacheClose': 'Fermer',
      'items.cacheCount': 'Elements',
      'items.cacheSize': 'Taille estimee',
      'items.cacheEmpty': 'Cache vide.',
      ...
      'itemdropper.title': 'Item Dropper',
      'itemdropper.subtitle': 'Importer une map de base, poser des items interactifs et exporter la couche gameplay.',
      'itemdropper.assets': 'Sheets items',
      'itemdropper.assetsSubtitle': 'Configurer les sheets d items interactifs et la collision si besoin.',
      'itemdropper.addAsset': 'Ajouter item',
      'itemdropper.assetGrid': 'Grille items',
      'itemdropper.assetGridHint': "Selectionner une sheet d items pour voir ses sprites.",
      'itemdropper.builder': 'Construction items',
      'itemdropper.builderHint': 'Poser des items interactifs directement sur la map de base.',
      'itemdropper.options': 'Options',
      ...
      'itemdropper.undo': 'Undo',
      'itemdropper.redo': 'Redo',
      'itemdropper.exportJson': 'Exporter JSON',
      'itemdropper.importJson': 'Importer JSON',
      'itemdropper.baseMap': 'Map de base',
      'itemdropper.baseMapEmpty': 'Aucune map de base chargee.',
      'itemdropper.refreshBaseMap': 'Rafraichir map de base',
      'itemdropper.cellSize': 'Taille case',
      'itemdropper.tool': 'Outil',
      'itemdropper.view': 'Vue',
      'itemdropper.viewNormal': 'Normal',
      'itemdropper.viewItems': 'Items',
      'itemdropper.viewCollision': 'Collision',
      'itemdropper.viewDepth': 'Profondeur joueur',
      'itemdropper.cacheTitle': 'Cache',
      'itemdropper.cacheClose': 'Fermer',
      'itemdropper.cacheCount': 'Elements',
      'itemdropper.cacheSize': 'Taille estimee',
      'itemdropper.cacheEmpty': 'Cache vide.',
      'itemdropper.cachePurge': 'Purger le cache',
      'itemdropper.maskTitle': 'Edit Mask',
      'itemdropper.maskSubtitle': 'Peins les zones passantes et bloquantes sur chaque sprite.',
      'itemdropper.maskBlocking': 'Bloquant',
      'itemdropper.maskPassable': 'Passant',
      'itemdropper.animationTitle': "Animation d'interaction",
      'itemdropper.animationSubtitle': "Configure l'image de depart, l'animation, l'image de fin et le loop pour la sheet selectionnee.",
      'itemdropper.animationStart': 'Image de depart',
      'itemdropper.animationFrames': "Images d'animation",
      'itemdropper.animationFramesHint': 'Utilise des virgules ou des intervalles, par exemple 2,3,4-6.',
      'itemdropper.animationEnd': 'Image de fin',
      'itemdropper.animationLoop': 'Loop',
      'itemdropper.animationLoopOn': 'Oui',
      'itemdropper.animationLoopOff': 'Non',
      'itemdropper.animationLoopFrom': 'Loop de',
      'itemdropper.animationLoopTo': 'Loop a',
      'itemdropper.animationPreview': 'Apercu',
      'itemdropper.animationTarget': 'Cible du picker',
      'npcdropper.title': 'NPC Dropper',
      'npcdropper.subtitle': 'Importer une map de base, poser des PNJ et exporter la couche personnages.',
      'npcdropper.assets': 'Sheets PNJ',
      'npcdropper.assetsSubtitle': 'Configurer les sheets PNJ, la direction, le comportement et la collision.',
      'npcdropper.addAsset': 'Ajouter PNJ',
      'npcdropper.assetGrid': 'Grille PNJ',
      'npcdropper.assetGridHint': 'Selectionner une sheet PNJ pour voir ses sprites.',
      'npcdropper.builder': 'Construction PNJ',
      'npcdropper.builderHint': 'Poser des PNJ directement sur la map de base.',
      'npcdropper.options': 'Options',
      ...
      'npcdropper.undo': 'Undo',
      'npcdropper.redo': 'Redo',
      'npcdropper.exportJson': 'Exporter JSON',
      'npcdropper.importJson': 'Importer JSON',
      'npcdropper.baseMap': 'Map de base',
      'npcdropper.baseMapEmpty': 'Aucune map de base chargee.',
      'npcdropper.refreshBaseMap': 'Rafraichir map de base',
      'npcdropper.cellSize': 'Taille case',
      'npcdropper.tool': 'Outil',
      'npcdropper.view': 'Vue',
      'npcdropper.viewNormal': 'Normal',
      'npcdropper.viewItems': 'PNJ',
      'npcdropper.viewCollision': 'Collision',
      'npcdropper.viewDepth': 'Profondeur joueur',
      'npcdropper.cacheTitle': 'Cache',
      'npcdropper.cacheClose': 'Fermer',
      'npcdropper.cacheCount': 'Elements',
      'npcdropper.cacheSize': 'Taille estimee',
      'npcdropper.cacheEmpty': 'Cache vide.',
      'npcdropper.cachePurge': 'Purger le cache',
      'npcdropper.maskTitle': 'Edit Mask',
      'npcdropper.maskSubtitle': 'Peins les zones passantes et bloquantes sur chaque sprite.',
      'npcdropper.maskBlocking': 'Bloquant',
      'npcdropper.maskPassable': 'Passant'
    }
  };
  ...
  const buildCanonicalBaseMapPayload = (payload, fallbackName = '', preferredMapId = '') => {
    ...
    const basePayload = {
      ...
      map: {
        ...
        cellSize: normalized.map.cellSize,
        assetColorPalette: normalized.assetColorPalette || normalized.map.assetColorPalette || 'studio',
        randomize: cloneProjectPayload(normalized.map.randomize || null),
        cells: cloneProjectPayload(normalized.map.cells) || [],
        markers: cloneProjectPayload(normalized.map.markers) || []
      }
    };
  ...
  const mergeBaseMapIntoStagePayload = (basePayload, stagePayload, fallbackName = '') => {
    ...
    const merged = {
      ...
      assetColorPalette: normalizedBase.assetColorPalette || normalizedBase.map.assetColorPalette || normalizedStage.assetColorPalette || 'studio',
  ...
  const mergeMatchingMapDocuments = () => {
    ...
    mapMergeStages.forEach((stage) => {
      ...
      Object.values(stageData?.documents || {}).forEach((entry) => {
        if (!entry?.payload?.map) return;
        const key = entry.normalizedLookupName || normalizeProjectLookupName(entry.lookupName || entry.displayName || entry.payload?.map?.name || '');
        if (!key) return;
        if (!groups.has(key)) groups.set(key, {});
        groups.get(key)[stage] = entry;
      });
    });
    ...
    groups.forEach((group, key) => {
      ...
      presentStages.forEach((stage) => {
        ...
        const nextPayload = stage === 'mapCreator'
          ...
          : mergeBaseMapIntoStagePayload(canonicalBase, entry.payload, entry.lookupName || key);
        project.stages[stage].documents[entry.docKey] = {
          ...project.stages[stage].documents[entry.docKey],
          payload: nextPayload,
          updatedAt: new Date().toISOString()
    ...
    if (mergedGroups > 0) {
      writeSharedProject(project);
      window.dispatchEvent(new CustomEvent('8bits-project-merged', { detail: { mergedGroups } }));
    }
    return mergedGroups;
  };
  ...
  const initMapCreator = () => {
    ...
    const cacheMergeMapsButton = qs('#map-cache-merge-maps');
